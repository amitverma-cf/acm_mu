    ...
    return (
        <>
            {Object.keys(teamsData).map((category) => (
                <div key={category} className="p-20 bg-bg">
                    <h2 className="text-3xl font-heading font-thin text-left px-4 mb-4 uppercase text-black dark:text-white">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-4">
                        {teamsData[category].map((person, index) => (
                            <div
                                key={index}
                                className="p-4 bg-white dark:bg-secondaryBlack border-2 border-r-4 border-b-4 border-black hover:border-r-2 hover:border-b-2"
                            >
                                <div className="text-center">
                                    ...
                                    <div className="mt-4 flex flex-row flex-wrap justify-center space-x-4 text-sm gap-2">
                                        {person.linkedin && (
                                            ...
                                            >
                                                <svg className="size-8" fill="currentColor" viewBox="0 0 448 512"aria-hidden="true">
                                                    <path
                                                        fillRule="evenodd"
                                        ...
                                        {person.github && (
                                            <Link
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="text-black dark:text-gray-300 hover:text-gray-800 dark:hover:text-white"
                                            >
                                                <svg className="size-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                                    <path
                                                        fillRule="evenodd"
                                        ...
                                        {person.instagram && (
                                            <Link
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="text-pink-500 dark:text-pink-700 hover:text-gray-800 dark:hover:text-white"
                                            >
                                                <svg className="size-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                                    <path
                                                        fillRule="evenodd"
                                        ...
                                        {person.leetcode && (
                                            <Link
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="text-yellow-500 dark:text-yellow-700 hover:text-gray-800 dark:hover:text-white"
                                            >
                                                <svg className="size-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                                    <path
                                                        fillRule="evenodd"
                                        ...
                                        {person.codeforces && (
                                            <Link
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="text-blue-500 dark:text-blue-700 hover:text-gray-800 dark:hover:text-white"
                                            >
                                                <svg className="size-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                                    <path
                                                        fillRule="evenodd"
                                        ...
                                        {person.hackerrank && (
                                            <Link
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="text-green-600 dark:text-green-800 hover:text-gray-800 dark:hover:text-white "
                                            >
                                                <svg className="size-8" fill="currentColor" viewBox="0 0 512 512" aria-hidden="true">
                                                    <path
                                                        fillRule="evenodd"
                                        ...
                                        {person.kaggle && (
                                            <Link
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="text-blue-500 dark:text-blue-700 hover:text-gray-800 dark:hover:text-white text-xs"
                                            >
                                                <svg className="size-8" fill="currentColor" viewBox="0 0 320 512" aria-hidden="true">
                                                    <path
                                                        fillRule="evenodd"
                                        ...
                                        {person.portfolio && (
                                            <Link
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="text-gray-700 dark:text-black hover:text-gray-800 dark:hover:text-white "
                                            >
                                                <svg className="size-8" fill="currentColor" viewBox="0 0 512 512" aria-hidden="true">
                                                    <path
                                                        fillRule="evenodd"
                                        ...
                                        {person.youtube && (
                                            <Link
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="text-red-600 dark:text-red-800 hover:text-gray-800 dark:hover:text-white"
                                            >
                                                <svg className="size-8" fill="currentColor" viewBox="0 0 576 512" aria-hidden="true">
                                                    <path
                                                        fillRule="evenodd"
                                        ...
                                        {person.facebook && (
                                            <Link
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="text-blue-700 dark:text-blue-900 hover:text-gray-800 dark:hover:text-white"
                                            >
                                                <svg className="size-8" fill="currentColor" viewBox="0 0 512 512" aria-hidden="true">
                                                    <path
                                                        fillRule="evenodd"
